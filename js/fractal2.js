...
var maxActiveParticles = 20; // Maximum number of active particles. This number is dynamic throughout the simulation.
...
function spawnParticles() {
    ...
    maxActiveParticles = Math.round(boundsArea/20);
	...
	for (var i = 0; i < maxActiveParticles-curActiveParticles; i++) {
        createParticle(true);
    }
}
